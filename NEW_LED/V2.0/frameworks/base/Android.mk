...
###############################################################################
#+US1-CF1
# feature: FW_VENDOR_SPRIT_FRAMEWORK_DEX
# andorid google source
FRAMEWORKS_EXT_SUBDIRS += \
		core/java/android/hardware/gesturedev \
		core/java/android/net/dhcp \
		core/java/android/server/search \
		core/java/android/service/dreams \
		core/java/android/service/textservice \
		core/java/com/android/internal/atfwd \
		core/java/com/android/internal/backup \
		core/java/com/android/internal/http/multipart \
		core/java/com/android/internal/preference \
		core/java/com/android/internal/widget/multiwaveview \
		core/java/com/google/android/mms \
		core/java/com/google/android/util \
		core/java/com/qualcomm \
		core/java/org/apache \
		core/java/org/codeaurora \
		icu4j/java/android/icu/text \
		core/java/android/service/wallpaper \
		pantech_fw/java/com/android/internal/pantech \
		voip/java/com/android/server/sip
		
FRAMEWORKS_EXT_AIDL_FILES := \
...
#+US1-CF1
#FEATURE : FW_VENDOR_ALWAYS_ON_TOP
FRAMEWORKS_EXT_SUBDIRS += \
       core/java/android/alwaysontopservice \
       core/java/com/pantech 

FRAMEWORKS_EXT_AIDL_FILES += \
	core/java/android/alwaysontopservice/IAlwaysOnTopInterface.aidl \
	../../pantech/frameworks/skyvtui/java/com/pantech/telephony/skyvtui/IVideoTelephony.aidl

#-US1-CF1

# [DS2 SMS] 
FRAMEWORKS_EXT_SUBDIRS += \
    core/java/android/provider/sms 
# [DS2 SMS]

# [PS2 Team] : [FEATURE_LGU_COMMON_TELEPHONY_IF]
FRAMEWORKS_EXT_SUBDIRS += \
  skytelephony/common/java/com/android/phone
#  core/java/android/lgt/handset
# [PS2 Team] : [FEATURE_LGU_COMMON_TELEPHONY_IF]

#+DS1-Settings-P10997
FRAMEWORKS_EXT_AIDL_FILES += \
	../../pantech/frameworks/sky_services/core/java/android/os/ISkyEcomodeService.aidl
PANTECH_FRAMEWORKS_EXT_SRC_FILES += \
	$(call find-other-java-files,../../pantech/frameworks/sky_services/core/java)
#-DS1-Settings-P10997

###############################################################################
# !!! +US1-CF1 
# PANTECH SOURCE MUST BE HERE
###############################################################################

PANTECH_FRAMEWORKS_EXT_SRC_FILES := \
	$(call find-other-java-files,../../vendor/pantech/frameworks/common/java) \
	$(call find-other-java-files,../../vendor/pantech/frameworks/audiotest/java) \
	$(call find-other-java-files,../../vendor/pantech/frameworks/audioutil/java) \
	$(call find-other-java-files,../../vendor/pantech/frameworks/bluetooth/java) \
	$(call find-other-java-files,../../vendor/pantech/frameworks/extstoragetest/java) \
	$(call find-other-java-files,../../vendor/pantech/frameworks/FUManager/java) \
	$(call find-other-java-files,../../vendor/pantech/frameworks/rftest/java) \
	$(call find-other-java-files,../../vendor/pantech/frameworks/sky_access_nand/java) \
	$(call find-other-java-files,../../vendor/pantech/frameworks/sky_ctrl_drv/java) \
	$(call find-other-java-files,../../vendor/pantech/frameworks/sky_dload/java) \
    $(call find-other-java-files,../../pantech/frameworks/SKYSettings/java) \
	$(call find-other-java-files,../../vendor/pantech/frameworks/sky_img_verify/java) \
    $(call find-other-java-files,../../vendor/pantech/frameworks/skycontact/java) \
    $(call find-other-java-files,../../vendor/pantech/frameworks/skyreset/java) \
	$(call find-other-java-files,../../vendor/pantech/frameworks/skyusimcontacts/java) \
	$(call find-other-java-files,../../vendor/pantech/frameworks/wifitest/java) \
        $(call find-other-java-files,../../vendor/pantech/frameworks/wifi_log/java) \
	$(call find-other-java-files,../../vendor/pantech/frameworks/skyreset/java) \
	$(call find-other-java-files,../../vendor/pantech/frameworks/rooting-detect/java)
###########################################################################
# SKY QSOUND Sound Effect for domestic models
PANTECH_FRAMEWORKS_EXT_SRC_FILES += \
	$(call find-other-java-files,../../vendor/qsound/frameworks/qfx/java) \
	$(call find-other-java-files,../../vendor/qsound/frameworks/qvss/java)
###########################################################################

#+US1-CF1
#feature: FW_VENDOR_SUPPORT_DIGITAL_PEN
PANTECH_FRAMEWORKS_EXT_SRC_FILES += \
	$(call find-other-java-files,../../vendor/pantech/frameworks/vpen/java)
#-US1-CF1

#+US1-CF1
#feature: FW_VENDOR_OEM_LED
PANTECH_FRAMEWORKS_EXT_SRC_FILES += \
	$(call find-other-java-files,pantech_fw/ext/java)
#-US1-CF1
#+US3-HomePart
PANTECH_FRAMEWORKS_EXT_SRC_FILES += \
	$(call find-other-java-files,../../vendor/pantech/frameworks/skywidget/java)
#-US3-HomePart

###############################################################################
#+LS6-TDMB
# andorid pantech source
ifeq ($(BUILD_WITH_SKY_TDMB),true)
PANTECH_FRAMEWORKS_EXT_SRC_FILES += \
	$(call find-other-java-files,../../vendor/pantech/frameworks/tdmb/java)		
endif

###############################################################################
# [11.07.27 zeros] Add VTS
ifeq ($(BUILD_WITH_SKY_VTS), true)
PANTECH_FRAMEWORKS_EXT_SRC_FILES += \
	$(call find-other-java-files,../../vendor/pantech/frameworks/vts/java)
endif
...
# PANTECH_CHANGE BEGIN build with cust browser[[
USE_CUSTMIZED_BROWSER := $(shell if [ -f $(LOCAL_PATH)/withCustBrowser.mk ]; then echo true; fi)

ifeq ($(USE_CUSTMIZED_BROWSER), true)
    framework_webkit_path := ../../../ANDROID_APPS/BROWSER_JB/BROWSER_JB/frameworks/base
else
    framework_webkit_path := ../../external/webkit/frameworks/base
endif # USE_CUSTMIZED_BROWSER
#]] PANTECH_CHANGE END
...
LOCAL_SRC_FILES += \
       ...
       $(framework_webkit_path)/core/java/android/webkit/EventLogTags.logtags \
...
LOCAL_SRC_FILES += \
    $(call find-other-java-files,../../pantech/frameworks/SkyNetworkSettings/java) \

# pcu_p11337 : [FEATURE_CALLUI] added callui framework
LOCAL_SRC_FILES += $(call find-other-java-files,../../vendor/pantech/frameworks/pcu/java) 
...
ifeq ($(BUILD_WITH_SKY_TDMB),true)
LOCAL_CFLAGS += -DSKY_TDMB_DEVELOP 
endif
################################################################
...
#+PS3 [FEATURE_SKY_IMS_INTERFACE]
FRAMEWORKS_EXT_AIDL_FILES +=\
	../../pantech/frameworks/ims/framework_ext/java/com/pantech/framework/ims/util/IImsServiceInterface.aidl
PANTECH_FRAMEWORKS_EXT_SRC_FILES += \
	$(call find-other-java-files,../../pantech/frameworks/ims/framework_ext/java)
#-PS3 [FEATURE_SKY_IMS_INTERFACE]


# 20120419 lcj@LS3 added WifiTest for 8378522
#LOCAL_SRC_FILES += \
#    $(call find-other-java-files,../../vendor/pantech/frameworks/wifitest/java)
...
#feature: FW_VENDOR_SUPPORT_DIGITAL_PEN
LOCAL_SRC_FILES += \
	core/java/android/view/IInterceptEventCallback.aidl \
	core/java/android/view/IDigitalPenManager.aidl \
	core/java/android/view/IDigitalPenEventListener.aidl
#-US1-CF1
#########################################################################
#------------------------------------------------------------------------
# [FEATURE_LGT_DS_ADD_DATA_AIDL]
LOCAL_SRC_FILES += \
	telephony/java/com/android/internal/telephony/ISkyDataConnection.aidl
#------------------------------------------------------------------------
# [FEATURE_LGT_DS_QMI_INTERFACE]
LOCAL_SRC_FILES += \
	telephony/java/com/android/internal/telephony/ISkyDSInfo.aidl
#------------------------------------------------------------------------
#########################################################################
...
#feature: FW_VENDOR_OEM_LED
LOCAL_SRC_FILES += \
	pantech_fw/ext/java/android/os/ISkyComplexService.aidl
#+US1-CF1

#fix build error (framework branch)
LOCAL_SRC_FILES += \
#    $(call find-other-java-files,../../vendor/pantech/frameworks/SKYSettings/java) \
    ../../vendor/pantech/frameworks/skyvtui/java/com/pantech/telephony/skyvtui/IVideoTelephony.aidl    
#-US1-CF1
...
LOCAL_SRC_FILES += \
	...
	core/java/com/android/internal/pantech/led/ILedManager.aidl
#

#(+)PPST
FRAMEWORKS_EXT_AIDL_FILES += \
	core/java/android/view/IPstManager.aidl \
#(-)PPST
#+++ [DS1_P11318] SKY_BLUETOOTH Patch Start
#PATCH = bluetooth handsfree patch
LOCAL_SRC_FILES += \
	../../pantech/frameworks/sky_services/core/java/android/os/ISKYBluetooth.aidl
#--- [DS1_P11318] SKY_BLUETOOTH Patch End
#+US1-CF1
#FEATURE : FW_VENDOR_ALWAYS_ON_TOP
LOCAL_SRC_FILES += \
	core/java/android/view/alwaysontop/IAlwaysOnTop.aidl
#-US1-CF1
# DS1-SKYUSIMCONTACT
LOCAL_SRC_FILES += \
	telephony/java/com/android/internal/telephony/ISkyIccPhoneBook.aidl
FRAMEWORKS_EXT_AIDL_FILES += \
	../../vendor/pantech/frameworks/pcu/java/com/pantech/pcu/telephony/IVoLTETelephony.aidl

# [PS2 Team] : [FEATURE_LGU_COMMON_TELEPHONY_IF] [FEATURE_LGU_GW_COMMON_TELEPHONY_IF]
# FEATURE_LGU_CP_GPS
LOCAL_SRC_FILES += \
	skytelephony/common/java/com/android/internal/telephony/ISkyTelephony.aidl
# FEATURE_LGU_CP_GPS
# [PS2 Team] : [FEATURE_LGU_COMMON_TELEPHONY_IF]

#+US1-CF1
LOCAL_SRC_FILES += \
	$(call find-other-java-files,./pantech_fw/java) 
#-US1-CF1

#+PS3 [FEATURE_SKY_IMS_INTERFACE]
LOCAL_SRC_FILES +=\
	$(call find-other-java-files,../../pantech/frameworks/ims/framework/java)
#-PS3 [FEATURE_SKY_IMS_INTERFACE]

# PS5-PS_UI
LOCAL_SRC_FILES += \
	$(call find-other-java-files,../../vendor/pantech/frameworks/skysettings_interface/java)
# PS5-PS_UI
...
#FEATURE : FW_VENDOR_ALWAYS_ON_TOP
aidl_files += \
	frameworks/base/core/java/android/view/alwaysontop/IAlwaysOnTop.aidl \
	frameworks/base/core/java/android/alwaysontopservice/IAlwaysOnTopInterface.aidl \
	frameworks/base/core/java/com/android/internal/pantech/led/LedInfo.aidl
#-US1-CF1
